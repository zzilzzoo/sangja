								...
								<div class="row">
									<div class="col-lg-12">
										<ul class="g-info list list-unstyled list-item-bottom-space-0">
											...
											<fmt:parseDate var="dateString" value="${salevo.sale_ymd}"
												pattern="yyyy-MM-dd" />
											<c:set var="sale_ymd">
									...
									<div class="col-lg-12">
												...
												<tbody>
													...
													<c:forEach items="${spvoList}" var="spvoList"
														...
														<tr>
															...
															<td><fmt:formatNumber value="${spvoList.unit_price}"
																	pattern="#,##0.00" /></td>
															<td><fmt:formatNumber value="${spvoList.sale_price}"
																	pattern="#,##0.00" /></td>
										...
										<div class="row justify-content-end mt-3">
											<a
												...
												class="bx bx-photo-album text-4 me-2"></i> View Saved
												Invoice
											</a>
