				...
				<form class="ecommerce-form action-buttons-fixed" action="#"
					...
					<div class="row">
						<div class="col">
							<section class="card card-dark">
								...
								<div class="card-body">
									<input type="hidden" class="form-control" name="cust_num"
										value="${view.cust_num}">
									...
									<div class="form-group row pb-4">
										...
										<div class="col-lg-6">
											<input type="text" class="form-control" name="zip_code"
												value="${view.zip_code}" required />
										</div>
									</div>
									<div class="form-group row pb-4">
										<label class="col-lg-3 control-label text-lg-end pt-2"
											for="inputDefault">Visit Term(Week)</label>
										<div class="col-lg-6">
											<input type="text" class="form-control" name="visit_term"
												value="${view.visit_term}">
										</div>
									</div>
									<div class="form-group row pb-4">
										<label class="col-lg-3 control-label text-lg-end pt-2"
											for="inputDefault">Status ${view.cust_status} <span
											class="required">*</span></label>
										<div class="col-lg-6">
											<select class="form-control" name="cust_status" required>
												<c:choose>
													<c:when test="${view.cust_status eq 'active'}">
												...
												<c:choose>
													<c:when test="${view.cust_status eq 'inactive'}">
												...
												<c:choose>
													<c:when test="${view.cust_status eq 'delete'}">
					...
					<div class="row action-buttons">
						...
						<div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
							<c:choose>
								<c:when test="${umvo.delete_yn eq 'y'}">
									<a href="customer-delete?cust_num=${view.cust_num}"
