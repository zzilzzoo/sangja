...
import com.sangja.dao.SaleFileDAO;
import com.sangja.domain.SaleFileVO;
import com.sangja.domain.SaleVO;

@Service
public class SaleFileServiceImpl implements SaleFileService {

	@Inject
	private SaleFileDAO dao;
